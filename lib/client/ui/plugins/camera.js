...
module.exports = {
    initialize: function () {
        ...
        upload.addEventListener('change', function () {
            ...
            // specifies DOM element to be used to render specific capture type
            var captureElementForType = {
              image: "img",
              audio: "audio",
              video: "video"
            };
            var captureType = getType();
            var captureElementName = captureElementForType[captureType] || captureType;
            var capture = document.createElement(captureElementName);
